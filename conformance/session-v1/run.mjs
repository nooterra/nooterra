...
function usage() {
  ...
  console.error("usage:");
  console.error(
    "  node conformance/session-v1/run.mjs [--adapter-bin <cmd>] [--adapter-node-bin <path/to/adapter.js>] [--case <id>] [--json-out <path>] [--cert-bundle-out <path>] [--strict-artifacts] [--list]"
  );
}
