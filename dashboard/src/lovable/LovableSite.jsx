    ...
    <nav className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.06] bg-[#08090d]/90 backdrop-blur-lg">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
        <a href="/" className="flex items-center gap-2 group">
          <NooterraLogo className="h-5 w-auto text-stone-100 group-hover:text-[#d2b06f] transition-colors" />
        </a>
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a
            ...
            className="inline-flex items-center rounded-md bg-gradient-to-r from-[#d2b06f] to-[#c4a05f] px-3.5 py-1.5 text-[13px] font-medium text-[#0b0f14] transition-all duration-150 hover:brightness-110"
      ...
      {mobileOpen ? (
        <div className="border-t border-white/[0.06] bg-[#08090d]/95 backdrop-blur-lg md:hidden">
          <div className="space-y-3 px-6 py-5">
            ...
            <div className="pt-2">
              <a href={DOCS_GETTING_STARTED} onClick={() => setMobileOpen(false)} className="inline-flex items-center rounded-md bg-gradient-to-r from-[#d2b06f] to-[#c4a05f] px-3.5 py-1.5 text-sm font-medium text-[#0b0f14]" target="_blank" rel="noopener noreferrer">
                Get started
              </a>
            </div>
          </div>
...
function SiteFooter() {
  return (
    <footer className="lovable-divider">
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div>
            <NooterraLogo className="h-4 w-auto text-stone-300" />
        ...
        <div className="mt-10 lovable-divider pt-6">
...
function SiteLayout({ children }) {
  return (
    <div className="min-h-screen bg-[#09090b] text-stone-300 lovable-grid-bg">
      <SiteNav />
...
function WorkerCard() {
  ...
  return (
    <div className="lovable-card overflow-hidden">
      {/* Worker header */}
      <div className="flex items-center justify-between border-b border-white/[0.04] px-5 py-3">
        <div className="flex items-center gap-3">
          <div className="h-2 w-2 rounded-full bg-emerald-500 lovable-pulse" />
...
function HomePage() {
  return (
    <SiteLayout>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              <FadeIn>
                <h1 className="text-[clamp(2.25rem,5vw,3.5rem)] leading-[1.08] tracking-[-0.03em] text-stone-100">
                  Describe the job.<br />
                  The worker <span className="lovable-gradient-text">handles it.</span>
                </h1>
              </FadeIn>
              <FadeIn delay={0.08}>
              ...
              <FadeIn delay={0.14}>
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  <a href={DOCS_GETTING_STARTED} className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-[#d2b06f] to-[#c4a05f] px-4 py-2.5 text-[13px] font-medium text-[#0b0f14] transition-all duration-150 hover:brightness-110" target="_blank" rel="noopener noreferrer">
                    Get started <ArrowRight size={14} />
                  </a>
                  <a href={ossLinks.repo} className="inline-flex items-center gap-2 rounded-md border border-white/[0.08] px-4 py-2.5 text-[13px] text-stone-500 transition-all duration-150 hover:border-white/[0.15] hover:text-stone-200" target="_blank" rel="noopener noreferrer">
                    <GitHubIcon className="h-4 w-4" /> View on GitHub <ArrowUpRight size={13} />
                  </a>
                </div>
              </FadeIn>
            </div>
            <FadeIn delay={0.2}>
              <div className="relative">
                <div className="lovable-hero-glow" />
                <div className="lovable-glow">
                  <WorkerCard />
                </div>
              </div>
            </FadeIn>
      ...
      {/* How it works */}
      <section className="lovable-divider">
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
          <FadeIn>
            ...
            <div className="mt-8 space-y-3">
              <div className="lovable-card p-4 flex items-start gap-3">
      ...
      <section className="lovable-divider">
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: "Customer Support", desc: "Triage tickets, draft responses, escalate edge cases.", icon: "\uD83C\uDFAB" },
              { title: "Data Monitor", desc: "Watch websites, detect changes, alert on Slack.", icon: "\uD83D\uDCE1" },
              { title: "Sales Researcher", desc: "Find leads, enrich data, draft personalized outreach.", icon: "\uD83D\uDD0D" },
              { title: "Competitor Tracker", desc: "Monitor pricing, features, and announcements.", icon: "\uD83D\uDCCA" },
              { title: "Content Moderator", desc: "Review submissions, flag violations, approve or reject.", icon: "\uD83D\uDEE1\uFE0F" },
              { title: "Invoice Processor", desc: "Extract data, match POs, route for approval.", icon: "\uD83E\uDDFE" }
            ].map((item, i) => (
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <FadeIn key={p.name} delay={i * 0.04}>
                <div className="lovable-card p-4">
        ...
        <div className="mx-auto max-w-6xl px-6 py-24 text-center md:py-32">
          <FadeIn>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <a href={DOCS_GETTING_STARTED} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-[#d2b06f] to-[#c4a05f] px-5 py-2.5 text-[13px] font-medium text-[#0b0f14] transition-all duration-150 hover:brightness-110">
                Get started <ArrowRight size={14} />
              </a>
    ...
    <SimplePage title="Privacy">
      <div className="grid gap-3 md:grid-cols-3">
        {[
          ...
          <div key={item.title} className="lovable-card p-6">
            <h3 className="mb-2 text-[14px] font-medium text-stone-200">{item.title}</h3>
            <p className="text-[13px] leading-relaxed text-stone-500">{item.desc}</p>
          </div>
        ))}
    ...
    <SimplePage title="Get help">
      <div className="grid gap-3 md:grid-cols-3">
        {[
          ...
          <a key={item.title} href={item.href} className="lovable-card block p-6" target="_blank" rel="noopener noreferrer">
            <h3 className="mb-2 text-[14px] font-medium text-stone-200">{item.title}</h3>
            <p className="text-[13px] leading-relaxed text-stone-500">{item.desc}</p>
  ...
  return (
    <SimplePage title={title}>
      ...
      <div className="mt-6 flex gap-3">
        <a href="/" className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-[#d2b06f] to-[#c4a05f] px-4 py-2 text-[13px] font-medium text-[#0b0f14]">Go home <ArrowRight size={14} /></a>
