  ...
  return (
    <div style={A.wrap}>
      ...
      <div style={A.inner} className="lovable-fade">
        ...
        <button style={socialBtnStyle} onClick={() => setError("Apple sign-in coming soon. Use email for now.")} onMouseOver={(e) => e.currentTarget.style.background = "#f9fafb"} onMouseOut={(e) => e.currentTarget.style.background = "#ffffff"}>
