  ...
  return (
    <div style={A.wrap}>
      ...
      <div style={A.inner} className="lovable-fade">
        ...
        {error && <div style={A.error}>{error}</div>}
        <button style={{ ...socialBtnStyle, opacity: 0.55, cursor: "default" }} onClick={() => setError("Google sign-in coming soon. Use email below.")} onMouseOver={() => {}} onMouseOut={() => {}}>
          ...
          Continue with Google <span style={{ fontSize: 11, color: "var(--text-300, #8a8a82)", marginLeft: 4 }}>soon</span>
        </button>
