...
const INTEGRATION_CATALOG = Object.freeze({
  phone:                { name: "Phone System",               provider: "Twilio",             required: true  },
  email:                { name: "Email",                      provider: "Gmail",              required: true  },
  sms:                  { name: "Text Messaging",             provider: "Twilio",             required: true  },
  calendar:             { name: "Calendar",                   provider: "Google Calendar",    required: true  },
  chat:                 { name: "Live Chat",                  provider: "Intercom",           required: false },
  accounting:           { name: "Accounting",                 provider: "QuickBooks",         required: false },
  payments:             { name: "Payment Processing",         provider: "Stripe",             required: false },
  crm:                  { name: "CRM",                        provider: "HubSpot",            required: false },
  reviews:              { name: "Review Platform",            provider: "Google Business",    required: false },
  social_media:         { name: "Social Media",               provider: "Meta Business Suite",required: false },
  email_marketing:      { name: "Email Marketing",            provider: "Mailchimp",          required: false },
  website:              { name: "Website",                     provider: "WordPress",          required: false },
  inventory:            { name: "Inventory Management",       provider: "inFlow",             required: false },
  pos:                  { name: "Point of Sale",              provider: "Square",             required: false },
  maps:                 { name: "Maps & Routing",             provider: "Google Maps",        required: false },
  video_conferencing:   { name: "Video Conferencing",         provider: "Zoom",               required: false },
  helpdesk:             { name: "Help Desk",                  provider: "Zendesk",            required: false },
  slack:                { name: "Team Communication",         provider: "Slack",              required: false },
  document_management:  { name: "Document Management",        provider: "Google Drive",       required: false },
  e_signature:          { name: "E-Signature",                provider: "DocuSign",           required: false },
  file_storage:         { name: "File Storage",               provider: "Google Drive",       required: false },
  time_tracking:        { name: "Time Tracking",              provider: "Toggl",              required: false },
  project_management:   { name: "Project Management",         provider: "Asana",              required: false },
  scheduling:           { name: "Staff Scheduling",           provider: "When I Work",        required: false },
  reservations:         { name: "Reservations",               provider: "OpenTable",          required: false },
  delivery_platforms:   { name: "Delivery Platforms",         provider: "DoorDash / UberEats",required: false },
  ecommerce_platform:   { name: "E-Commerce Platform",       provider: "Shopify",            required: false },
  shipping:             { name: "Shipping",                   provider: "ShipStation",        required: false },
  ehr:                  { name: "Electronic Health Records",  provider: "Practice Fusion",    required: false },
  insurance_verification:{ name: "Insurance Verification",    provider: "Availity",           required: false },
  fax:                  { name: "Fax",                        provider: "eFax",               required: false },
  mls:                  { name: "MLS Access",                 provider: "Local MLS",          required: false },
  channel_manager:      { name: "Channel Manager",            provider: "Guesty",             required: false },
  pms:                  { name: "Property Management System", provider: "Cloudbeds",          required: false },
  shop_management:      { name: "Shop Management",            provider: "Shop-Ware",          required: false },
  parts_suppliers:      { name: "Parts Suppliers",            provider: "AutoZone / NAPA",    required: false },
  tms:                  { name: "Transportation Management",  provider: "Samsara",            required: false },
  eld:                  { name: "Electronic Logging Device",  provider: "KeepTruckin",        required: false },
  load_boards:          { name: "Load Boards",                provider: "DAT / Truckstop",    required: false },
