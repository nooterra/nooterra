# Settld Positioning One-Pager (2026-02-24)

## Category

Settld is the neutral trust and settlement control plane for autonomous agents.
...
Settld provides a host-agnostic control plane with:
...
Settld is positioned at that bottleneck.
...
3. Host neutrality: OpenClaw, Codex, Claude Desktop, Cursor, custom runtimes.
...
- Terminal-first onboarding (`settld setup/login/doctor`)

Secondary distribution:

- Public protocol specs for ecosystem adoption
- “Settld Verified” conformance badge for providers/runtimes

## 30-day goals

1. Publish public collaboration specs.
2. Launch Settld Verified v1 criteria and badge checks.
