...
function writeExplain({ out, args, err }) {
  const lines = [];
  lines.push("nooterra-produce explain");
  ...
  if (codes.has(PRODUCE_ERROR_CODE.VERIFY_AFTER_FAILED)) {
    lines.push("hint: verify-after failed; run nooterra-verify directly for details");
  }
...
function usage() {
  writeStderr(
    [
      "usage:",
      "  nooterra-produce jobproof --out <bundleDir> (--keys <keypairs.json> | --signer remote --gov-key-id <id> --server-key-id <id> [--signer-url <url> | --signer-command <cmd> --signer-args-json <json>] [--signer-auth bearer --signer-token-env <ENV>|--signer-token-file <path>] [--signer-header \"X-Foo: bar\"] | --signer plugin --signer-plugin <path|pkg> [--signer-plugin-export <name>] [--signer-plugin-config <json>]) [--tenant <id>] [--job-id <id>] [--format json|text] [--deterministic] [--now <iso>] [--force]",
      "  nooterra-produce monthproof --out <bundleDir> (--keys <keypairs.json> | --signer remote --gov-key-id <id> --server-key-id <id> [--signer-url <url> | --signer-command <cmd> --signer-args-json <json>] [--signer-auth bearer --signer-token-env <ENV>|--signer-token-file <path>] [--signer-header \"X-Foo: bar\"] | --signer plugin --signer-plugin <path|pkg> [--signer-plugin-export <name>] [--signer-plugin-config <json>]) [--tenant <id>] [--period YYYY-MM] [--basis <settledAt|...>] [--format json|text] [--deterministic] [--now <iso>] [--force]",
      "  nooterra-produce financepack --out <bundleDir> (--keys <keypairs.json> | --signer remote --gov-key-id <id> --server-key-id <id> [--signer-url <url> | --signer-command <cmd> --signer-args-json <json>] [--signer-auth bearer --signer-token-env <ENV>|--signer-token-file <path>] [--signer-header \"X-Foo: bar\"] | --signer plugin --signer-plugin <path|pkg> [--signer-plugin-export <name>] [--signer-plugin-config <json>]) --monthproof <monthProofBundleDir> [--tenant <id>] [--period YYYY-MM] [--protocol <string>] [--format json|text] [--deterministic] [--now <iso>] [--force]",
      "  nooterra-produce invoicebundle --out <bundleDir> (--keys <keypairs.json> | --signer remote --gov-key-id <id> --server-key-id <id> [--signer-url <url> | --signer-command <cmd> --signer-args-json <json>] [--signer-auth bearer --signer-token-env <ENV>|--signer-token-file <path>] [--signer-header \"X-Foo: bar\"] | --signer plugin --signer-plugin <path|pkg> [--signer-plugin-export <name>] [--signer-plugin-config <json>]) --jobproof <jobProofBundleDir> [--tenant <id>] [--invoice-id <id>] [--protocol <string>] [--format json|text] [--deterministic] [--now <iso>] [--force]",
      "  nooterra-produce closepack --out <bundleDir> (--keys <keypairs.json> | --signer remote --gov-key-id <id> --server-key-id <id> [--signer-url <url> | --signer-command <cmd> --signer-args-json <json>] [--signer-auth bearer --signer-token-env <ENV>|--signer-token-file <path>] [--signer-header \"X-Foo: bar\"] | --signer plugin --signer-plugin <path|pkg> [--signer-plugin-export <name>] [--signer-plugin-config <json>]) --invoicebundle <invoiceBundleDir> [--tenant <id>] [--invoice-id <id>] [--protocol <string>] [--format json|text] [--deterministic] [--now <iso>] [--force]",
      "  nooterra-produce closepack-from-json --out <bundleDir> (--keys <keypairs.json> | --signer remote --gov-key-id <id> --server-key-id <id> [--signer-url <url> | --signer-command <cmd> --signer-args-json <json>] [--signer-auth bearer --signer-token-env <ENV>|--signer-token-file <path>] [--signer-header \"X-Foo: bar\"] | --signer plugin --signer-plugin <path|pkg> [--signer-plugin-export <name>] [--signer-plugin-config <json>]) --jobproof <jobProofBundleDir> --pricing-matrix <pricing_matrix.json> --pricing-signatures <pricing_matrix_signatures.json> --metering-report <metering_report.json> [--invoice-claim <invoice_claim.json>] [--sla-definition <sla_definition.json>] [--acceptance-criteria <acceptance_criteria.json>] [--tenant <id>] [--invoice-id <id>] [--protocol <string>] [--format json|text] [--deterministic] [--now <iso>] [--force]",
      "",
...
async function main() {
  ...
  try {
    ...
    const out = buildProduceCliOutputV1({
      tool: { name: "nooterra", version: packageVersion, commit: toolCommit },
