...
function usage() {
  writeStderr(
    [
      "usage:",
      "  server mode:",
      "    nooterra-signer-dev --keys <keypairs.json> [--host 127.0.0.1] [--port 0]",
      "  stdio (one-shot) mode:",
      "    nooterra-signer-dev --stdio --keys <keypairs.json>   # reads JSON request from stdin, writes JSON response to stdout",
      "    nooterra-signer-dev --stdio --keys <keypairs.json> --request-json-base64 <b64>   # avoids stdin piping (some CI sandboxes)",
      "",
