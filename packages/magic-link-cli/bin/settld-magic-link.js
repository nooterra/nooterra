...
function usage() {
  ...
  console.error(
    [
      "usage:",
      "  settld-magic-link upload <InvoiceBundle.v1.zip> --url <http(s)://host[:port]> [--mode auto|strict|compat] [--tenant <id>] [--format json|text]",
      "  settld-magic-link ingest <InvoiceBundle.v1.zip> --url <http(s)://host[:port]> --tenant <buyerTenant> --ingest-key <igk_...> [--mode auto|strict|compat] [--contract <id>] [--format json|text]",
      "  settld-magic-link tenant get --url <http(s)://host[:port]> --tenant <id> [--format json|text]",
      "  settld-magic-link tenant set --url <http(s)://host[:port]> --tenant <id> [--default-mode auto|strict|compat] [--format json|text]",
      "  settld-magic-link tenant trust set --url <http(s)://host[:port]> --tenant <id> --file <trust-roots.json> [--format json|text]",
      "  settld-magic-link ingest-key create --url <http(s)://host[:port]> --tenant <buyerTenant> --vendor <vendorId> [--vendor-name <name>] [--expires-at <iso>] [--format json|text]",
      "  settld-magic-link ingest-key revoke --url <http(s)://host[:port]> --tenant <buyerTenant> --key-hash <64hex> [--reason <text>] [--format json|text]",
      "  settld-magic-link vendor pack --url <http(s)://host[:port]> --tenant <buyerTenant> --vendor <vendorId> [--vendor-name <name>] [--contract <id>] [--expires-at <iso>] [--pricing-matrix <pricing_matrix.json>] [--pricing-signatures <pricing_matrix_signatures.json>] --out <pack.zip>",
      "  settld-magic-link inbox --url <http(s)://host[:port]> --tenant <buyerTenant> [--status green|amber|red|processing] [--vendor <vendorId>] [--contract <id>] [--from <iso>] [--to <iso>] [--limit <n>] [--format json|text]",
      "  settld-magic-link billing export --url <http(s)://host[:port]> --tenant <id> [--month <YYYY-MM>] --out <invoice.pdf> [--format pdf|json]",
      "",
      "env:",
