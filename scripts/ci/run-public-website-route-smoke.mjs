...
const DEFAULT_ROUTE_CHECKS = [
  { path: "/", needles: ["Give agents wallets, not unchecked permissions.", "/signup#account-create"] },
  { path: "/product", needles: ["for every consequential agent action.", "/signup#account-create"] },
  { path: "/pricing", needles: ["Free to build.", "/signup#account-create"] },
  { path: "/developers", needles: ["Add an Action Wallet in minutes.", "/signup#account-create"] },
  { path: "/integrations", needles: ["Connect where agents already run.", "/signup#account-create"] },
  ...
  { path: "/signup", needle: "Create your workspace." },
  { path: "/login", needle: "Return to your workspace." },
  { path: "/account", needle: "Create your workspace." },
