...
export default function WelcomeBox() {
  ...
  return el(Box, { flexDirection: 'column' },
    ...
    el(Text, null, ''),
    el(Box, { marginLeft: 1 },
      el(Text, { color: palette.info }, 'Automate any task'),
      el(Text, null, ' \u2014 just describe what you need in plain English.'),
    ),
    el(Box, { marginLeft: 1 },
      el(Text, { color: palette.textDim }, "Try: 'monitor competitor prices' or type "),
      el(Text, { bold: true }, '/templates'),
      el(Text, { color: palette.textDim }, ' for quick starts'),
    ),
    el(Text, null, ''),
  );
}
